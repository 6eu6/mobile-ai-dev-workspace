      ...
      <Card className="bg-palmkit-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <span className="px-3 py-1 bg-gray-500/10 text-gray-600 text-xs font-medium rounded-full">Recommended</span>
          </div>
        </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <ol className="text-xs text-palmkit-elements-textSecondary space-y-1 list-decimal list-inside ml-2">
                    ...
                    <li>
                      ...
                      <code className="bg-palmkit-elements-background-depth-4 px-1 rounded">
